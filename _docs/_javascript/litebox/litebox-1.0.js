/**
 * @fileoverview Contains "lightbox" image displayer popup class and functions, used to display 
 *               images in a window with a semi-transparent overlay placed over the current browser
 *               viewport. Supports browsing through a list of linked images!
 *               
 ...
 * @version      $Id: litebox-1.0.js 715 2011-06-12 20:06:27Z conor $
 */
...
Lightbox.prototype = {
	...
	start: function(imageLink) {	
		...
		var arrayPageSize = getPageSize();
		var arrayPageScroll = getPageScroll();
		if (arrayPageSize[3] <= 580) {
			// Don't waste space with largish borders on small viewports
			var lightboxTop = arrayPageScroll[1] + 10;
		} else {
			// Base vertical centring on expected average tallest image (460px) and 40 pixels for
			// textual description at bottom
			var lightboxTop = arrayPageScroll[1] + (((arrayPageSize[3] - 460) / 2) - 40);
		}
