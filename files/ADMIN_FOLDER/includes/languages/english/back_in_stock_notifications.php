...
define('TEXT_PREVIEW_OUTPUT_TITLE_SINGULAR', 'Only one notification would have been sent at this time. An example of this notification has <span class="u"><strong>already</strong></span> been sent (but using the currently-selected Admin language).');
define('TEXT_PREVIEW_OUTPUT_TITLE_PLURAL', '%s notifications would have been sent at this time. An example of the first notification has <span class="u"><strong>already</strong></span> been sent (but using the currently-selected Admin language).');
...
define('TEXT_NOTE_OPTION_4', '<h5>These notification emails have been sent.</h5>');
define('TEXT_NOTE_OPTION_4_LANGS', '<p>Only emails matching the currently-selected Admin language have been sent.</p><p>To send any remaining emails for other languages, change the Admin language to match the email(s) language, this will reload this page for Option 4 and send the matching-language emails.</p>');
...
define('TEXT_TITLE_VIEW_CUSTOMER','view customer record');
