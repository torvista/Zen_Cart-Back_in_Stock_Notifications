 ...
 * @version     $Id: tpl_back_in_stock_notification_subscribe_default.php 719 2011-06-13 18:00:43Z conor $
 */
...
if ($build_form) {
	...
	$continue_button = '<a href="' . zen_href_link(FILENAME_PRODUCT_INFO, zen_get_all_get_params(),
