 ...
 * @author  Conor Kerr <zen-cart.back-in-stock-notifications@dev.ceon.net>
 */
function getSubscribedBackInStockNotificationLists(int $customer_id): array
{
    global $db;
...
$subscribed_notification_lists =
    getSubscribedBackInStockNotificationLists((int)$_SESSION['customer_id']);
