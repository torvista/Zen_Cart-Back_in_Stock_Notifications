 ...
 * @version     $Id: class.CeonXHTMLHiTemplate.php 2023-11-11 torvista
 */
...
// Use current user's browser's settings
            if (isset($GLOBALS['ceon']['session']->browser)) {
...
// Activate all sections which satisfy the "anything but this browser"  ////
        do {
...
// Remove preceding/prevailing whitespace
